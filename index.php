...
//                            ?>
                            ...
                            <form id="formAuthentication" class="mt-5 mb-5 login-input" action="views/auth/page-login.php" method="POST">
                            ...
                            <p class="mt-5 login-form__footer">Dont have account? <a href="views/auth/page-register.php" class="text-primary">Register</a> now</p>
                        </div>
                    </div>
                </div>
            </div>
