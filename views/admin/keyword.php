                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Keywords
                            <button type="button" class="btn mb-1 btn-primary" style="float: right;" onclick="window.location.href='../auth/page-login.php'">Add keyword<span class="btn-icon-right"><i class="fa fa-plus"></i></span>
                            </button>
                        </h4>
